...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		<div class="nav">
			...
			<ul class="menu">
				<li><a class="active" href="../cas_books_list.php">Books</a></li>
...
$query = "select * from cas_book_toc where book_id='$book_id' and type='$type' order by slno";
...
$query_aux = "select * from cas_books_list where book_id=$book_id and type='cas'";
...
$query_aux1 = "select * from cas_books_list where level='1' and slno < '$slno' order by slno desc limit 1";
...
*/
echo "<div class=\"page_booktitle\"><span class=\"motif cas_motif\"></span><span class=\"itl\">$book_title</span></div>";
echo "<div class=\"page_other gap_above\">";
