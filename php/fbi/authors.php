...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		<div class="nav">
			...
			<ul class="menu">
				<li><a href="../fbi_books_list.php">Books</a></li>
		...
		<div class="archive_holder">
			<div class="page_title"><span class="motif fbi_motif"></span>Authors <span class="it">(Fauna of British India)</span></div>
			<div class="alphabet">
...
{
	echo "<li>Sorry! No author names were found to begin with the letter '$letter' in Fauna of British India</li>";
}
