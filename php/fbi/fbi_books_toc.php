...
$query = "select * from fbi_book_toc where book_id=$book_id and type='$type' order by slno";
...
if($num_rows > 0)
{
	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		{
			$title = "<span class=\"featurespan\"><a href=\"fbi_si.php?book_id=$book_id&amp;type=$type&amp;book_title=" . urlencode($book_title) . "\">$title</a></span>";
		}
		else
		{
