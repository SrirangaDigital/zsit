...
$query = "select * from fi_systematic_index where book_id=$book_id and type='$type' order by slno";
...
echo "<div class=\"page_booktitle\"><span class=\"motif fi_motif\"></span><span class=\"itl\">$book_title</span></div>";
