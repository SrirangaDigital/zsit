...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		<div class="nav">
			<div class="archive_title">Fauna of<br />India</div>
			<ul class="menu">
				<li><a class="active" href="fi_books_list.php">Books</a></li>
				<li><a href="fi/authors.php">Authors</a></li>
		...
		<div class="archive_holder">
			<div class="page_title"><span class="motif fbi_motif"></span>Fauna of British India | Fauna of India</div>

<?php
include("fbi/connect.php");


$db = mysql_connect("localhost",$user,$password) or die("Not connected to database");
$rs = mysql_select_db($database,$db) or die("No Database");

$query = "select * from fbi_books_list order by slno";
...
if($num_rows)
{
	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		if($page != "")
		{
			if($authid != 0)
			{
				$title = "<span class=\"titlespan\"><a href=\"".$type."/".$type."_books_toc.php?book_id=$book_id&amp;type=$type&amp;book_title=$title\">$title</a></span><br />" . $disp_author;
			}
			else
			{
				$title = "<span class=\"titlespan\"><a href=\"".$type."/".$type."_books_toc.php?book_id=$book_id&amp;type=$type&amp;book_title=$title\">$title</a></span><br />";
			}
