...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		...
		<div class="archive_holder">
			<div class="page_title"><span class="motif mem_motif"></span>Articles <span class="it">(Memoirs)</span></div>
			<div class="alphabet">
...
if($letter == 'Special')
{
	$query = "select * from article_memoirs where title not regexp '^[a-zA-Z].*' order by title, volume, part, page";
}
else
{
