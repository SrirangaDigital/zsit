...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		...
		<div class="about">
			...
			<p>The personal information of users collected through the website of digital archive shall be used by Zoological Survey of India only to manage the archive and such information shall not be transferred to any third party. However, the personal information may be used by ZSI to generate user statistics and to create a database of taxonomists working on fauna of the Indian subcontinent. Electronic newsletters/E-mails may be sent to the users on updates of activities of Zoological Survey of India or any other communications related to the archive.</p>
		</div>
	</div>
