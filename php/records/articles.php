...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		...
		<div class="archive_holder">
			<div class="page_title"><span class="motif rec_motif"></span>Articles <span class="it">(Records)</span></div>
			<div class="alphabet">
...
if($num_rows > 0)
{
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		$ArticlePDFUrl = '../../PDFVolumes/records/' . $volume . '/' . $part . '/' . $page . '-' . $row['page_end'] . '.pdf';
