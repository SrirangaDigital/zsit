...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		<div class="nav">
			...
			<ul class="menu">
				<li><a class="active" href="../sfs_books_list.php">Books</a></li>
...
$query_aux1 = "select * from sfs_books_list where level='1' and slno < '$slno' order by slno desc limit 1";
...
*/
echo "<div class=\"page_booktitle\"><span class=\"motif sfs_motif\"></span><span class=\"itl\">$book_title</span></div>";
