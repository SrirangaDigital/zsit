	...
	<div class="mainpage">
		<div class="nav">
			...
			<ul class="menu">
				...
				<li><a href="sfs/authors.php">Authors</a></li>
		...
		<div class="archive_holder">
			<div class="page_title"><span class="motif sfs_motif"></span>State Fauna Series</div>

<?php
include("sfs/connect.php");


$db = mysql_connect("localhost",$user,$password) or die("Not connected to database");
$rs = mysql_select_db($database,$db) or die("No Database");

$query = "select * from sfs_books_list order by slno";
