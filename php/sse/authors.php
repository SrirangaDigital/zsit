...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		<div class="nav">
			...
			<ul class="menu">
				<li><a href="../sse_books_list.php">Books</a></li>
		...
		<div class="archive_holder">
			<div class="page_title"><span class="motif sse_motif"></span>Authors <span class="it">(Status Survey of Endangered Species)</span></div>
			<div class="alphabet">
...
{
	echo "Sorry! No author names were found to begin with the letter '$letter' in Status Survey of Endangered Species";
}
