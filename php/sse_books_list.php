	...
	<div class="mainpage">
		<div class="nav">
			...
			<ul class="menu">
				...
				<li><a href="sse/authors.php">Authors</a></li>
		...
		<div class="archive_holder">
			<div class="page_title"><span class="motif sse_motif"></span>Status Survey of Endangered Species</div>

<?php
include("sse/connect.php");


$db = mysql_connect("localhost",$user,$password) or die("Not connected to database");
$rs = mysql_select_db($database,$db) or die("No Database");

$query = "select * from sse_books_list order by slno";
...
if($num_rows)
{
	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		if($page != "")
		{
			...
			$title_parse = preg_replace('/!/', "", $title_parse);
