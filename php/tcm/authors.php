...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		<div class="nav">
			...
			<ul class="menu">
				<li><a href="../tcm_books_list.php">Books</a></li>
		...
		<div class="archive_holder">
			<div class="page_title"><span class="motif tcm_motif"></span>Authors <span class="it">(Technical Monographs)</span></div>
			<div class="alphabet">
...
{
	echo "<li>Sorry! No author names were found to begin with the letter '$letter' in Technical Monographs</li>";
}
