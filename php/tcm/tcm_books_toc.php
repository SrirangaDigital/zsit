...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		<div class="nav">
			<div class="archive_title">Technical<br />Monographs</div>
			<ul class="menu">
...
$query = "select * from tcm_book_toc where book_id=$book_id and type='$type' order by slno";
...
$query_aux = "select * from tcm_books_list where book_id=$book_id and type='tcm'";
...
*/
echo "<div class=\"page_booktitle\"><span class=\"motif tcm_motif\"></span><span class=\"itl\">$book_title</span></div>";
