...
<?php include("include_nav.php");?>
	...
	<div class="mainpage">
		<div class="nav">
			<div class="archive_title">Zoologiana</div>
			<ul class="menu">
				<li><a class="active" href="../zlg_books_list.php">Books</a></li>
...
$query = "select * from zlg_book_toc where book_id='$book_id' and type='$type' order by slno";
...
*/
echo "<div class=\"page_booktitle\"><span class=\"motif zlg_motif\"></span><span class=\"itl\">$book_title</span></div>";
