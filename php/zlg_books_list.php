	...
	<div class="mainpage">
		<div class="nav">
			...
			<ul class="menu">
				...
				<li><a href="zlg/authors.php">Authors</a></li>
		...
		<div class="archive_holder">
			<div class="page_title"><span class="motif zlg_motif"></span>Zoologiana</div>

<?php
include("zlg/connect.php");
...
$query = "select * from zlg_books_list order by slno";
